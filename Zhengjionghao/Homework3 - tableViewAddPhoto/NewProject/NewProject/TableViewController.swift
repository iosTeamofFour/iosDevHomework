...
class TableViewController: UITableViewController {
    ...
    func initList() {
        ...
        if let initFoodList: [Food] = loadFoodFile(){
            ...
            foodList.append(Food(name: "米饭", img: nil))
            foodList.append(Food(name: "蛋糕", img: nil))
            foodList.append(Food(name: "水果", img: nil))
            foodList.append(Food(name: "面食", img: nil))
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.foodImage.image = foodList[indexPath.row].foodImage
